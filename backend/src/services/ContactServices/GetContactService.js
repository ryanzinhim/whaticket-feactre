...
var CreateContactService_1 = require("./CreateContactService");
var GetContactService = function (_a) {
    var name = _a.name, number = _a.number;
    return __awaiter(void 0, void 0, void 0, function () {
        var numberExists, contact;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    numberExists = _b.sent();
                    if (!!numberExists) return [3 /*break*/, 3];
                ...
                case 2:
                    ...
                    _b.label = 3;
                case 3: return [2 /*return*/, numberExists];
            }
        });
    });
};
